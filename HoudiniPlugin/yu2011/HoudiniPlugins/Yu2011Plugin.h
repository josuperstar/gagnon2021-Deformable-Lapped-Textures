...
public:
    ...
    fpreal  AlphaThreshold() { return evalFloat("AlphaThreshold", 0, 0); }
    fpreal  UpdateDistribution() { return evalFloat("UpdateDistribution", 0, 0); }
    fpreal  TangentTrackerLenght() { return evalFloat("TangentTrackerLenght", 0, 0); }
    fpreal  MinimumDistanceProjection() { return evalFloat("MinimumDistanceProjection", 0, 0); }
    fpreal  InnerCircleRadius() { return evalFloat("InnerCircleRadius", 0, 0); }//
    fpreal  ConnectivityTest() { return evalFloat("ConnectivityTest", 0, 0); }//
    fpreal  VelocityTransfertRadius() { return evalFloat("VelocityTransfertRadius", 0, 0); }//
    fpreal  NormalTransfertRadius() { return evalFloat("NormalTransfertRadius", 0, 0); }//
    fpreal  UvTransfertRadius() { return evalFloat("UvTransfertRadius", 0, 0); }//
    fpreal  AlphaTransfertRadius() { return evalFloat("AlphaTransfertRadius", 0, 0); }//
    fpreal  GridResolution() { return evalFloat("GridResolution", 0, 0); }//
    fpreal  DeleteConcealed() { return evalFloat("DeleteConcealed", 0, 0); }
    fpreal  ComputeDistortion() { return evalFloat("ComputeDistortion", 0, 0); }
    fpreal  DistortionTheshold() { return evalFloat("DistortionThreshold", 0, 0); }
    fpreal  DistortionMaxTheshold() { return evalFloat("DistortionMaxThreshold", 0, 0); }
    fpreal  SqueezeMinTheshold() { return evalFloat("SqueezeMinThreshold", 0, 0); }
    fpreal  SqueezeMaxTheshold() { return evalFloat("SqueezeMaxThreshold", 0, 0); }
    fpreal  DeletionLife() { return evalFloat("DeletionLife", 0, 0); }
    fpreal  Yu2011DMax() { return evalFloat("Yu2011DMax", 0, 0); }
    fpreal  QvMin() { return evalFloat("QvMin", 0, 0); }
    fpreal  DistortionRatioThreshold() { return evalFloat("DistortionRatioThreshold", 0, 0); }
    fpreal  AngleNormalThreshold() { return evalFloat("AngleNormalThreshold", 0, 0); }
    fpreal  TestPatch() { return evalFloat("TestPatch", 0, 0); }
    fpreal  ComputeAtlas() { return evalFloat("ComputeAtlas", 0, 0); }
