...
OP_Node *
SinglePatchTest::myConstructor(OP_Network *net, const char *name, OP_Operator *op)
{
    return new SinglePatchTest(net, name, op);
}

SinglePatchTest::SinglePatchTest(OP_Network *net, const char *name, OP_Operator *op)
...
SinglePatchTest::~SinglePatchTest()
{
...
OP_ERROR
SinglePatchTest::cookInputGroups(OP_Context &context, int alone)
{
...
OP_ERROR
SinglePatchTest::cookMySop(OP_Context &context)
{
    ...
    cout << "======================== SinglePatchTest, frame  "<<frame<< "============================="<<endl;
...
const char *
SinglePatchTest::inputLabel(unsigned) const
{
    return "SinglePatchTest";
}
