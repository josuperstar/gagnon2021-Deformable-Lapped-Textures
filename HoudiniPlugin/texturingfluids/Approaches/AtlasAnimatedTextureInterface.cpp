#include "AtlasAnimatedTextureInterface.h"
...
#include <Core/Atlas/AtlasAnimatedTexture.h>
#include <Core/Atlas/TBBAtlasAnimatedTexture.h>
#include <tbb/parallel_for.h>


AtlasAnimatedTextureInterface::AtlasAnimatedTextureInterface()
{
}
...
bool AtlasAnimatedTextureInterface::Synthesis(GU_Detail *gdp,  GU_Detail *surfaceGdp, GU_Detail *trackersGdp, ParametersDeformablePatches params)
{
    cout << "[AtlasAnimatedTextureInterface::Synthesis] "<<params.frame<<endl;

    std::clock_t start;
    start = std::clock();

    AtlasAnimatedTexture atlas;
    ...
    if(!usingTbb)
    {
        cout << "[AtlasAnimatedTextureInterface::Synthesis] without tbb"<< "Rasterizing an "<<params.atlasHeight << " x "<<params.atlasWidth<<" image."<<endl;
    ...
    else
    {
        ...
        AnimatedTexture_executor exec(atlas,params.atlasWidth,params.atlasHeight,params);
