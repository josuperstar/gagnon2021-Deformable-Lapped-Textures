#ifndef __AAtlasDeforamblePatchesInterface_h__
#define __AAtlasDeforamblePatchesInterface_h__
...
class AtlasDeformablePatchesInterface
{

public:

    //=========================== BUILD ======================================
    AtlasDeformablePatchesInterface();
    ~AtlasDeformablePatchesInterface();
