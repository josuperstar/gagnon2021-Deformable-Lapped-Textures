...
#ifndef __DeformableLappedtTexturePlugin_h__
#define __DeformableLappedtTexturePlugin_h__
#include <vector>
...
class DeformableLappedTexturePlugin : public SOP_Node
{
public:
    DeformableLappedTexturePlugin(OP_Network *net, const char *name, OP_Operator *op);
    virtual ~DeformableLappedTexturePlugin();
...
private:
    ...
    DeformableLappedTexture interface;
